...
const ProjectModal = ({ users, currentUser, initialData, onClose, onSave, toast }: any) => {
...
const TaskDetailModal = ({ project, users, currentUser, settings, onClose, onUpdate, onMoveStatus, onEditProject, toast }: any) => {
